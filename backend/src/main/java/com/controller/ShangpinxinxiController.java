...
public class ShangpinxinxiController {
    ...
    public R detail(@PathVariable("id") Long id){
        ShangpinxinxiEntity shangpinxinxi = null;
        ...
        try {
            if(redisUtil != null) {
                ...
                if(cached != null) {
                    shangpinxinxi = (ShangpinxinxiEntity) cached;
                    fromCache = true;
                }
            }
        } catch (Exception e) {
        ...
        if(shangpinxinxi == null) {
            shangpinxinxi = shangpinxinxiService.selectById(id);
        }
		...
		if(shangpinxinxi != null) {
            ...
            if(!fromCache) {
                ...
                try {
                    if(redisUtil != null) {
                        redisUtil.set("product:detail:" + id, shangpinxinxi, 30, TimeUnit.MINUTES);
                    }
                } catch (Exception e) {
                    // Redis不可用，忽略
                }
    ...
    public R update(@RequestBody ShangpinxinxiEntity shangpinxinxi, HttpServletRequest request){
        ...
        try {
            if(redisUtil != null) {
                redisUtil.delete("product:detail:" + shangpinxinxi.getId());
            }
        } catch (Exception e) {
            // Redis不可用，忽略
        }
